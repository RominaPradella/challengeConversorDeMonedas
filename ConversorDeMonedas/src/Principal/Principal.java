...
public class Principal {
    ...
    public static void main(String[] args ){
        ...
        while(true){
            String opciones = (JOptionPane.showInputDialog(null, "Seleccionar una opción de conversión", "Menu", JOptionPane.QUESTION_MESSAGE, null, new Object[]{"Conversor de Monedas", "Conversor de Temperatura", "Conversor de Peso"}, "Seleccion")).toString();
